...
class TeacherConfig:
    ...
    Attributes:
        ...
        allow_teachers:
            Currently supported teachers.
            Must be updated when adding more supported teachers.
        batch_size:
            Training batch size.
            Minimum is `1`.
        beta1:
        ...
        dataset:
            ...
            If `dataset` is empty string, then `self.dataset` will be
            initialized with `TeacherConfig.format_experiment_name`.
        dropout:
            Dropout probability.
            Must be ranging from `0` to `1` (inclusive).
        epoch:
    ...
    def __init__(
        ...
        if not dataset:
            dataset = TeacherConfig.format_experiment_name(
