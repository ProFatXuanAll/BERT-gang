...
class TeacherConfig:
    ...
    def format_experiment_name(
        ...
        return f'ex-{experiment}-teacher-{teacher}-task-{task}'

    @staticmethod
    def format_evaluation_name(
            dataset: str,
            experiment: str = '',
            task: str = '',
            teacher: str = ''
    ) -> str:
        r"""Return formatted evaluation name.
            This method is used for model evaluation on different dataset.
        ...
        Returns:
        ---
            A string of evaluation name.
        """
        return f'{TeacherConfig.format_experiment_name(experiment,task,teacher)}-dataset-{dataset}'
...
class StudentConfig:
    ...
    def format_experiment_name(
        ...
        Returns:
            A string of experiment name.
        """
        return f'ex-{experiment}-student-{student}-task-{task}'
    ...
    def format_evaluation_name(
        ...
        ---
            dataset:
                Name of dataset generated by teacher model.
            experiment:
                Name of experiment.
            task:
                Name of fine-tune task.
        ...
        ---
            A string of evaluation name.
        """
        return f'{StudentConfig.format_experiment_name(experiment,task,student)}-dataset-{dataset}'
