...
Usage:
    python train_lrc_bert.py

Run `python train_lrc_bert.py -h` for help, or see documentation
...
# Get main logger.
logger = logging.getLogger('fine_tune.train_lrc_bert')
logging.basicConfig(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--hard_label_weight',
        default=0.8,
        help="loss weight (gamma) of hard target cross entropy." +
    ...
    # Start training.
    logger.info("Strat LRC BERT training")
    fine_tune.util.train_lrc_layerwise(
        ...
        nce_cos_weight=args.nce_cos_weight,
        soft_weight=args.soft_label_weight,
        hard_weight=args.hard_label_weight,
