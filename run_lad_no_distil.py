...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--gate_beta1',
        default=0.9,
        help="Gate Netowrk's optimizer: `torch.optim.AdamW`'s beta coefficients.",
        type=float
    )
    parser.add_argument(
        '--gate_beta2',
    ...
    parser.add_argument(
        '--gate_eps',
        default=1e-8,
        help="Gate Netowrk's optimizer: `torch.optim.AdamW`'s epsilon.",
        type=float,
    )
    parser.add_argument(
        '--gate_lr',
        default=1e-5,
        help="Gate Netowrk's optimizer: `torch.optim.AdamW`'s learning rate.",
        type=float,
    )
    parser.add_argument(
        '--gate_max_norm',
    ...
    parser.add_argument(
        '--gate_weight_decay',
        default=0.01,
        help="Gate Netowrk's optimizer: `torch.optim.AdamW` weight decay regularization.",
        type=float,
    )
    ...
    logger.info("Train LAD-NO with Gate Networks")
    fine_tune.util.train_LAD_NO(
